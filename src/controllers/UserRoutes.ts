...
// And with this UserRoutes array I'm setting all the base routes instead. So this is now SRP and DRY. I only have to add routes here and it'll render out new routes to the navbar.
